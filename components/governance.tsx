...
export function Governance() {
  ...
  const voteOnProposal = async (proposalId: number, support: boolean) => {
    ...
    try {
      ...
      const proposalData =
        await governanceContract.getProposalDetails(proposalId);
  ...
  const executeProposal = async (proposalId: number) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "There was an error executing the proposal. Please try again.",
        variant: "destructive",
      });
    } finally {
  ...
  const cancelProposal = async (proposalId: number) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "There was an error canceling the proposal. Please try again.",
        variant: "destructive",
      });
    } finally {
    ...
    switch (state) {
      case 0: // Active
        return (
          <Badge
            variant="default"
            className="bg-lightblue-100 text-lightblue-700 border-lightblue-300"
          >
            Active
          </Badge>
        );
        ...
        <TabsContent value="proposals">
          {loading ? (
            ...
            <div className="space-y-4">
              {proposals.map((proposal) => (
                <Card key={proposal.id}>
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <CardDescription>
                          Created by {proposal.proposer.substring(0, 6)}...
                          {proposal.proposer.substring(38)} on{" "}
                          {new Date(
                  ...
                  <CardContent>
                    <p className="mb-6 text-lightblue-800">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="bg-red-50 p-4 rounded-lg border border-red-100">
                        ...
                        <div className="text-xl font-semibold text-red-700">
                          {Number.parseFloat(proposal.votesAgainst).toFixed(2)}{" "}
                          sETH
                        </div>
                      </div>
                    </div>
            ...
            <Card className="p-6 text-center border-dashed border-lightblue-200">
              ...
              <h3 className="text-lg font-medium mb-2 text-lightblue-800">
                No proposals yet
              </h3>
              <p className="text-lightblue-600 max-w-md mx-auto mb-6">
                Be the first to create a governance proposal and help shape the
        ...
        <TabsContent value="create">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Create a new governance proposal. You need at least 1 sETH to
                create a proposal.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="block text-sm font-medium text-lightblue-800">
                    Description
                  </label>
                  <Textarea
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-lightblue-600">
                    The contract address that will be called if the proposal
                    passes.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-lightblue-600">
                    The function call data to be executed if the proposal
                    passes.
                  </p>
                </div>
                ...
                {Number.parseFloat(sETHBalance) < 1 && (
                  ...
                  >
                    ...
                    <AlertDescription>
                      You need at least 1 sETH to create a proposal. Stake your
                      dETH to receive sETH.
                    </AlertDescription>
                  </Alert>
                )}
              </div>
