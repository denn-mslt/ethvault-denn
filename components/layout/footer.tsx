      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-white/90 text-sm mb-4">
              A decentralized platform for ETH staking and governance. Stake
              your ETH, earn rewards, and participate in protocol governance.
            </p>
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-1">
            ...
            <p className="text-white/90 text-sm mb-4">
              Subscribe to our newsletter for the latest updates on ETHVault
        ...
        <div className="border-t border-white/20 mt-8 md:mt-12 pt-6 md:pt-8 flex justify-center">
          <p className="text-white/80 text-sm">
            {mounted && (
              <>
                &copy; {currentYear} ETHVault Governance Platform. All rights
                reserved.
              </>
            )}
          </p>
